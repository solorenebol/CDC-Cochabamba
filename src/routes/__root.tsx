...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "CDCC Cochabamba — El tejido vivo de nuestras culturas" },
      { property: "og:description", content: "Registro Plurinacional de Artistas, gobernanza participativa y agenda cultural del departamento de Cochabamba." },
